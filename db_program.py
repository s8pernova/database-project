...
def select_record(db_cursor):
    ...
    tuple_of_value = (id,)  # The comma in (id,) is to make it count as a tuple, even though there's only one value
...
def delete_record(db_cursor):
    ...
    result_set = db_cursor.fetchall()  # This is to check if the record exists in the first place
